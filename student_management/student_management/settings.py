...
SECRET_KEY = 'django-insecure-_beoepn$f^ktla+ltczw^0j=cf15wj2z^0)p_(2$rxg7ieo!58'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'student_management',  # Tên database
        'USER': 'root',                # Tên user MySQL
        'PASSWORD': '12345',    # Mật khẩu MySQL
        'HOST': 'localhost',           # Địa chỉ host (nếu dùng trên local)
